...
The increased digitization of the retail sector\textcolor{blue}{, however, also provides a means to address the churn problem.} Large volumes of \textcolor{blue}{customer interaction data and purchase histories are now stored digitally in retailers' data warehouses.} This \textcolor{blue}{enables the training and deployment of AI and machine learning methods for the early detection of potential churners and for the development of targeting marketing intervention.}
In the early 2000s, customer churn prediction leveraging machine learning and AI has seen considerable application, initially in industries with contractual customer relationships, such as telecommunications \cite{Predicting-subscriber-dissatisfaction-Mozer}. 
...
\begin{figure}[ht]
    \centering
    \includegraphics[width=0.6\textwidth]{selection-process.pdf}
...
\begin{figure}[!htbp]
    \centering
    \includegraphics[width=\textwidth]{PS_RQ3_affiliation_countries.png}
...
\begin{table}[H]
    ...
    \includegraphics[width=0.91\textwidth]{Bibliometrics_analysis.pdf}
\end{table}
...
\input{04-publication-venues} %now is left aligned
...
\textbf{\begin{table}[t]
    ...
    \includegraphics[width=\textwidth]{RS_RQ2_features.pdf}
\end{table}}
\FloatBarrier
...
\begin{table}[H]
    ...
    \includegraphics[width=\linewidth]{RS_RQ4_techniques.pdf}
    %\vspace{-2.5cm}
\end{table}
...
\begin{table}[H]
    ...
    \label{table:metrics}
    \includegraphics[width=\linewidth]{RS_RQ5_metrics.pdf}
\end{table}
...
\input{04-challenges-and-limitations}
