...
\begin{table}[H]
\centering
\caption{Search strings for IEEE and ACM\textcolor{orange}{\protect\footnotemark}.}
...
\end{table}
\footnotetext{\textcolor{orange}{Although the search strings differ in their textual form, they were adapted to the syntax and interface constraints of each digital library while preserving the same conceptual search strategy.}}
