...
\input{tables/04-descriptive-summary}
...
The datasets cover both online (E-Commerce) and offline (Brick-and-Mortar) scenarios and span multiple retail sectors, including merchandise, fashion, electronics, and food. These datasets differ not only in the retail sector they are related to, but also in structural characteristics, going from using only transactional records to multidimensional data including geo-demographic, behavioral, and interactional features. \\
...
Table~\ref{table:available_datasets} summarizes the main characteristics of the publicly available datasets identified in the reviewed studies.
