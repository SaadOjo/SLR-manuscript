...
\journal{International Journal of Information Management Data Insight}
...
\author[inst1,inst2]{Niccolò Ciucci Colli\corref{cor1}} %% Author name
\ead{niccolo.ciuccicolli@uniroma1.it}
\ead{niccolo.ciuccicolli@uniroma1.it}
\cortext[cor1]{Corresponding author. Tel.: +39 3475029774.}
\author[inst1,inst2]{Syed Saad Saif}
\author[inst2]{Giulio Maggiore}
\author[inst2]{Damiano Distante}

%% use optional labels to link authors explicitly to addresses:
%% Author affiliation
\affiliation[inst1]{organization={Department of Computer, Control, and Management Engineering, Sapienza University of Rome},%Department and Organization
            addressline={Piazzale Aldo Moro, 5}, 
            city={Rome},
            postcode={00185}, 
            %state={Italy},
            country={Italy}}
\affiliation[inst2]{organization={Department of Law and Economics, University of Rome UnitelmaSapienza},%Department and Organization
...
%\begin{highlights}
%\item Comprehensive SLR answering 11 research questions on AI applied to churn prediction
